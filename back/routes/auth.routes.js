...
// Route protected by the isAuthenticated middleware function. 
// If the user is authenticated, the function retrieves the user object from the database 
// and sends it to the client as a JSON response
router.get('/verify', isAuthenticated, async (req, res) => {
  console.log(req.tokenPayload)
  const currentUser = await User.findById(req.tokenPayload.userId)
  res.status(200).json({message: `${currentUser} verified`})
})
